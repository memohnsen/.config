...
(map! :leader
      ...
      :desc "Open Ghostty in project" "o g" #'mm/open-ghostty-project
...
(defun mm/open-ghostty-project ()
  "Open Ghostty in the current project root."
  (interactive)
  (let ((dir (expand-file-name (or (doom-project-root) default-directory))))
    (start-process "ghostty" nil "open" "-n" "-a" "Ghostty" "--args" (concat "--working-directory=" dir))))
#+end_src
